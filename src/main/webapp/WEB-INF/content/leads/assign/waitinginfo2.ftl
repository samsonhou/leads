			  	 	 ...
			  	 	 <div class="float-e-margins">
						 ...
						 <div class="form-group"> 
                                ...
                                <div class="col-sm-4">
                                  ...
                                  &nbsp; &nbsp;
                                  <input type="button" id="closeBtn" value="关 闭" class="btn btn-primary btn-sm zd-btn-pd1">
                                </div>
                           </div>
                           </#if>
			  	 	 	 </div>
	...
	<script type="text/javascript">
		function assign(){
			if(jQuery("#sidName").val()==''){
				...
				form1.action="${contextPath}/leads/assign/wait/assgin.do?from=index";
				form1.submit();
			}
		}
		...
		jQuery(document).ready(function(){
			...
			if(message.length>0){
				layer.alert("${message}",function(index){
					form1.action="${contextPath}/indexPage.do";
					form1.submit();
				});
