	...
	<form  method="post" name="form1" id="form1" class="form-horizontal">
		...
		<div class="container-fluid">
			<div class="panel panel-default" style="margin-top: 1px;">
				<div class="panel-heading">滴滴来源销售排行</div>
				...
				<table class="table table-condensed table-bordered table-striped table-hover" id="table1">
                                <thead>
                                    <tr>
		                 		 		...
		                 		 		<th style="text-align: center;">风控通过数量</th>	
	...
	<script type="text/javascript">
    	...
    	var demo = $("#form1").Validform({
    		beforeCheck:function(curform){
    			$("#form1").attr("action","${contextPath}/leads/report/ddRank.do");
    			$("#isQuery").val("Y");
    		}
    	});
    	
    	function excel(){
    		demo.submitForm(false,"${contextPath}/leads/report/ddRankExport.do");
    	}
