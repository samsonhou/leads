				...
				<table class="table table-condensed table-bordered table-striped table-hover" id="table1">
                                <thead>
                                    <tr>
		                 		 		...
		                 		 		<th style="text-align: center;">邀约率</th>	
		                 		 		<th style="text-align: center;">到店率</th>	
		                 		 		<th style="text-align: center;">进件率</th>	
		                 		 		<th style="text-align: center;">通过率</th>	
		                 		 		<th style="text-align: center;">交车率</th>	
		                 		 		<th style="text-align: center;">投诉率</th>	
	...
	<script type="text/javascript">
    	...
    	var demo = $("#form1").Validform({
    		beforeCheck:function(curform){
    			$("#form1").attr("action","${contextPath}/leads/report/ddStatistics.do");
    			$("#isQuery").val("Y");
    		}
    	});
    	
    	function excel(){
    		demo.submitForm(false,"${contextPath}/leads/report/ddStatisticsExport.do");
    	}
