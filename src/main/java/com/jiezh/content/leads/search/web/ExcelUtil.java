...
public class ExcelUtil {
    ...
    private static void setConfmap() {
        // 1=线索查询表头
        String[] title1 = new String[] {"是否已结算", "外部订单号", "客户姓名", "业务类别", "手机", "客服专员", "门店", "客户经理 ", "来源", "租赁产品", "小定金支付情况", "风控审核状态", "是否可退小定金",
            "客服首次邀约时间", "客服首次邀约详情", "客服末次邀约时间", "门店一次邀约时间", "门店一次邀约详情", "门店二次邀约时间", "门店二次邀约详情", "门店三次邀约时间", "门店三次邀约详情", "门店末次邀约时间", "门店末次邀约详情",
            "预判等级", "预判C级原因", "预判D级原因", "到店时间", "是否到店", "大定金支付情况", "是否邀约", "进件时间", "是否进件", "签约时间", "是否签约", "提车时间", "是否提车", "花生合同", "是否可回收", "礼品发放"};
